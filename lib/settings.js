...
const knownSettings = {
  ...
  filterOnLabels: undefined
};

exports.formatters = {
  filterOnLabels: (labels) => labels?.split(/,\s*/g) || []
};
...
exports.set = async (setting, value, skipWrite) => {
  ...
  if (knownSettings[setting] && !knownSettings[setting].includes(value)) {
